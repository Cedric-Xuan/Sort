...
public class ChineseToSpell {
    ...
    //取全部首字母
    public static String getAllFirstSpell(String cnStr) {
        if (null == cnStr || "".equals(cnStr.trim())) {
            return cnStr;
        }
    ...
    //取前两首字母
    public static String getTwoFirstSpell(String cnStr) {
        if (null == cnStr || "".equals(cnStr.trim())) {
            return cnStr;
        }
    ...
    //取前三首字母
    public static String getThreeFirstSpell(String cnStr) {
        if (null == cnStr || "".equals(cnStr.trim())) {
            return cnStr;
        }
    ...
    public static void main(String[] args) {
        ...
        // 转换成拼音
        System.out.println(ChineseToSpell.getFullSpell(str));
        // 中文第一个字全拼,其余去首字母
        System.out.println(ChineseToSpell.getFirstSpell(str));
        //获得全部首字母
        System.out.println(ChineseToSpell.getAllFirstSpell(str));
        //获得前两首字母
        System.out.println(ChineseToSpell.getTwoFirstSpell(str));
        //获得前三首字母
        System.out.println(ChineseToSpell.getThreeFirstSpell(str));
        // ascii 转 字母
        System.out.println(ChineseToSpell.getSpellByAscii(65));
        // 字母 转 ascii
        System.out.println(ChineseToSpell.getCnAscii('0'));
    }
}